...
public class BankAccountServiceTest {
	...
	public void makeFakeDepositWithZeroAmount() throws InvalidAmountException {
		Assert.assertEquals(BigDecimal.ZERO,
				updateAccountBalance(new Account(), BigDecimal.ZERO, TransactionType.DEPOSIT, LocalDateTime.now()));
	}

	@Test(expected = InvalidAmountException.class)
	public void makeFakeDepositWithNullAmount() throws InvalidAmountException {
		updateAccountBalance(new Account(), null, TransactionType.DEPOSIT, LocalDateTime.now());
	}

	@Test(expected = InvalidAmountException.class)
	public void makeNegativeWithdrawalFromAccount() throws InvalidAmountException {
		updateAccountBalance(new Account(), BigDecimal.valueOf(-20.00d), TransactionType.WITHDRAWAL, LocalDateTime.now());
	}

	@Test(expected = InvalidAmountException.class)
	public void makeFakeWithdrawalWithZeroAmount() throws InvalidAmountException {
		updateAccountBalance(new Account(), BigDecimal.ZERO, TransactionType.WITHDRAWAL, LocalDateTime.now());
	}

	@Test(expected = InvalidAmountException.class)
	public void makeFakeWithdrawalWithNullAmount() throws InvalidAmountException {
		updateAccountBalance(new Account(), null, TransactionType.WITHDRAWAL, LocalDateTime.now());
	}
	...
	public void printOneWithdrawal() throws InvalidAmountException {
		Account account = new Account();
		updateAccountBalance(account, BigDecimal.valueOf(10.00d), TransactionType.WITHDRAWAL, LocalDateTime.of(2019, 2, 1, 00, 00));
